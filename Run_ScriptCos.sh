...
java -classpath /home/billowkib/Development/Projects/RedesNeuronales/RedesNeurales/bin com.redesneurales.regresion.Cosenoidal.RegresionCosenoidal $delta $iteraciones $origen
cd /home/billowkib/Development
gnuplot RegresionCosScript.gp
eog -f resultado.png
exit 0
